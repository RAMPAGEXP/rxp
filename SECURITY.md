# RXP bug reporting and feature requests

The RXP core development team uses GitHub to manage feature requests and bugs. This is done via GitHub Issues.

## Triage and progress 🔜

Issues added to GitHub will be triaged as they come in.

Tracking of in-flight issues will be done through the RXP Core project board, but of course we reserve the right to not make a public issue if there is a security implication in doing so.

## Feature request 🚀

For a feature request, e.g. module inclusion, please make a GitHub issue. Clearly state your use case and what value it will bring to other users or developers on RXP.
...
- Demonstrate good faith by not disrupting or degrading RXP’s network, data, or services.

### Vulnerability Disclosure Process

RXP uses the following disclosure process:

- Once a security report is received, the RXP core development team works to verify the issue.
...
This process can take some time. Every effort will be made to handle the bug in as timely a manner as possible. However, it's important that we follow the process described above to ensure that disclosures are handled consistently and to keep RXP and the projects running on it secure.
