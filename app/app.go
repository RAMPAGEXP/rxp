...
import (
	...
	"github.com/RAMPAGEXP/rxp/v7/docs"
	"github.com/RAMPAGEXP/rxp/v7/x/mint"
	mintkeeper "github.com/RAMPAGEXP/rxp/v7/x/mint/keeper"
	minttypes "github.com/RAMPAGEXP/rxp/v7/x/mint/types"
...
func GetWasmOpts(appOpts servertypes.AppOptions) []wasm.Option {
	...
	wasmOpts = append(wasmOpts, wasmkeeper.WithGasRegister(NewRXPWasmGasRegister()))
...
// New returns a reference to an initialized RXP.
func New(
	logger log.Logger,
	db dbm.DB,
...
// AppCodec returns RXP's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
...
// InterfaceRegistry returns RXP's InterfaceRegistry
